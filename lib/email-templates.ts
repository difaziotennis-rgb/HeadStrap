  ...
  if (isMember) {
    const html = emailWrapper(`
      ...
      <div class="body">
        ...
        <div style="margin-top:12px; padding:10px 12px; background:#faf9f7; border:1px solid #ece8e2; border-radius:10px; text-align:center;">
          <p style="font-size:11px; color:#8a8477; margin:0 0 6px;">Need to cancel?</p>
          <a href="${cancellationLink}" class="btn btn-outline" style="font-size:10px; padding:6px 12px;">Cancel Lesson</a>
          <p class="muted" style="margin-top:6px; font-size:11px;">72-hour cancellation policy applies.</p>
        </div>
      </div>
