...
export const STUDIO_SPOTLIGHT: HomePhoto = {
  ...
  alt: "Ellen DiFazio’s studio and gallery space at 62 Aarow Road, Hilton Head, South Carolina",
  caption: "Studio & gallery — Hilton Head",
};
...
export const AWARDS_AND_EXHIBITIONS: HomePhoto[] = [
  {
    ...
    caption: "Second Place — National Biennial 2025",
  },
  {
    ...
    caption: "Artists of Sea Pines Gallery",
  },
  {
    ...
    caption: "The Montage, Palmetto Bluff",
  },
  {
    ...
    caption: "Roots of the Low Country — Montage",
  },
  {
    ...
    caption: "The Brick Art Studio — Stony Brook, NY",
  },
  {
    ...
    caption: "Featured Artist — Montage Library",
  },
  {
    ...
    caption: "Hilton Head Symphony program",
  },
  {
    ...
    caption: "Art Center of Coastal Carolina",
  },
  {
    ...
    alt: "Gestures in Nature solo exhibit at Art Center of Coastal Carolina",
    caption: "Gestures in Nature — solo exhibit",
  },
  {
    ...
    caption: "First Thursday — Sea Pines Center",
  },
  {
    ...
    alt: "Solo exhibit at The Art Center of Coastal Carolina — lecture and demonstration",
    caption: "Solo exhibit & demonstration — Art Center",
  },
];
