            ...
            <section>
              ...
              <div className="mt-4 space-y-3 text-[14px] text-[#4a4540] leading-relaxed">
                ...
                <p>
                  ...
                  a <strong className="text-[#1a1a1a] font-medium">4 game mini-set</strong> finale for the
                  top two teams, and a courtside social.
                </p>
              </div>
            </section>
            ...
            <section className="rounded-2xl border border-[#e8e5df] bg-white p-6 sm:p-7 shadow-sm">
              ...
              <ol className="mt-5 space-y-4">
                {[
                  ...
                  {
                    t: "Finale & social",
                    d: "Top two by points: 4 game mini-set showcase; then prizes, bites, and mingling.",
                  },
                ].map((item, i) => (
