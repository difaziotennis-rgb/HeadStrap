    ...
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 z-0">
        <Image
          ...
          alt="Derek DiFazio"
          fill
          className="object-cover object-top scale-[1.52] sm:scale-100 origin-top"
          priority
        />
      ...
      <header className="relative z-40 bg-black/30 backdrop-blur-sm border-b border-white/10 sticky top-0">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/book" className="text-[10px] tracking-[0.25em] uppercase text-white/50 hover:text-white/70 transition-colors">
                DiFazio Tennis
              </Link>
            </div>
