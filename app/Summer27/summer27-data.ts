...
export const s27Clinics: ClinicDef[] = [
  ...
  },
  {
    ...
    guestPrice: 70,
    description:
      "Match-tempo point construction, serve + 1 patterns, and competitive games. Best for 4.0+ or by pro invitation.",
    blockCourts: ["court-1", "court-2"],
  },
  {
    id: "mon-fri-beginner",
    name: "Beginner Evening Clinic",
    kind: "adult",
    level: "Beginner",
    days: [1, 5],
    startHour: 17,
    ...
    guestPrice: 45,
    description:
      "Rally fundamentals, toss and contact, and easy live-ball games. A calm first step into club play.",
    blockCourts: ["court-1", "court-2"],
  },
  {
    id: "mon-fri-int-adv",
    name: "Weeknight Intermediate / Advanced",
    kind: "adult",
    level: "Intermediate / Advanced",
    days: [1, 5],
    startHour: 18,
