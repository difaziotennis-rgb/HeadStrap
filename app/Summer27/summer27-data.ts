...
export const s27Clinics: ClinicDef[] = [
  ...
  {
    id: "sat-night-rr",
    name: "Saturday Night Round Robin Match Play",
    kind: "adult",
    level: "3.0+ · all welcome",
    days: [6],
    startHour: 17,
    durationHours: 1.5,
    capacity: 12,
    memberPrice: 55,
    guestPrice: 70,
    description: "Evening round robin match play on both courts. Rotating partners and competitive sets.",
    blockCourts: ["court-1", "court-2"],
  },
  {
    id: "tue-am-juniors",
