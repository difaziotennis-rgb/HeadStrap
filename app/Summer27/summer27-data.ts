...
export const s27Clinics: ClinicDef[] = [
  ...
  {
    id: "thu-am-ladies-doubles",
    name: "Thursday Ladies Doubles Strategy",
    kind: "adult",
    level: "3.0+ · doubles focus",
    days: [4],
    startHour: 9,
    durationHours: 1,
    capacity: 10,
  ...
  {
    id: "thu-hs-juniors",
    name: "High School Juniors Clinic",
    kind: "junior",
    level: "High school · match play & development",
    days: [4],
    startHour: 17,
    durationHours: 1,
    capacity: 8,
...
export const s27Events: EventDef[] = [
  ...
  {
    id: "wimbledon-finals-party",
    title: "Wimbledon Finals Doubles Tournament & Viewing Party",
    date: "2027-07-11",
    ...
    guestPrice: 70,
    description:
      "Club doubles on Courts 3 & 4 while the Wimbledon finals play in the clubhouse — tournament draw in the morning, then strawberries, Pimm’s, and Centre Court on the screen.",
    highlights: ["Doubles tournament", "Wimbledon finals on screen", "Clubhouse viewing party"],
    image: "/s27/events/member-guest.jpg",
    theme: { wash: "#1f3d2a", soft: "#eef4ea", accent: "#4f7358" },
  },
  {
  ...
  },
  {
    ...
    guestPrice: 60,
    description:
      "Doubles 105 on Courts 3 & 4. Play to 105: groundstroke winners 5, volley winners 10, overhead or lob winners 25. Partner optional — we’ll pair you.",
    highlights: ["Play to 105", "Winners 5 · volleys 10", "Overhead or lob 25"],
